...
export default function CreateCourse() {
        ...
        curriculum: [
            {
                module_name: "",
                module_time: "",
                lessons: [{ lesson_name: "", duration: "", video: "" }],
            },
        ],
    ...
    // handle array of strings (whatWillILearn)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch("https://api.slanster.com/api/v1/offline/course/create", {
                method: "POST",
                headers: {
        ...
        <div className="max-w-5xl mx-auto p-6 bg-white shadow-lg rounded-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <br />
                    Course Period: 30–90 Days, 6 Months
                </div>
